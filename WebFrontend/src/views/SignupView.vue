...
<template>
  ...
  <div class="absolute w-full h-144 top-32 flex justify-center items-center">
    <div class="w-11/12 max-w-200 h-full shadow-md bg-white rounded-md">
      ...
      <div class="flex justify-center items-center w-full h-16 py-14">
      ...
      <div class="flex justify-center items-center w-full h-80">
        ...
        <div v-if="formCheck.name">
          <label class="input w-full input-bordered input-primary flex items-center gap-2">
        ...
        <div v-else>
          <label class="input w-full input-bordered input-error flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4"><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" /></svg>          
            <input v-model="formData.name" type="text" class="grow" placeholder="Name" @change="checkValidName" />
          </label>
        ...
        <div v-else>
          ...
          <div class="label"> <span class="label-text-alt text-error">Password must be at least 6 characters long</span> </div>
        </div>
      ...
      <div class="text-secondary text-xs py-2"> 
        <p class="w-full text-center h-6">
